  ...
  return (
    <div className="relative min-h-screen">
      ...
      <img
        src="/stockly.png"
        alt="Stockly Logo"
        className="absolute top-0 left-0 h-64 w-auto object-contain"
      />

      {/* Sağ üst SIGN UP butonu */}
      ...
      <div className="p-8 lg:w-1/2 mx-auto">
        <div className="bg-gray-100 rounded-lg py-12 px-4 lg:px-24">
          <h2 className="text-xl text-gray-800 font-semibold uppercase text-left mb-4">Log In</h2>
